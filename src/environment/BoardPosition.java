...
public class BoardPosition {
	public final int x; //COLUMNS
	public final int y; //ROWS
	...
	//Saber a distância entre uma BoardPosition e esta - útil para o Goal (q.b)
	//if(nextPosition) tem uma distanceTo do Goal menor da que eu tenho --> avanço para ela (cobras auto)
	...
	//não útil, já utilizado no Board.
